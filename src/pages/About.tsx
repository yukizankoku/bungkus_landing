...
export default function About() {
  ...
  // Fallback content
  const hero = content?.hero || { title: t('Tentang Bungkus Indonesia', 'About Bungkus Indonesia'), subtitle: t('Mitra kemasan terpercaya untuk korporasi dan UMKM di seluruh Indonesia.', 'Trusted packaging partner for corporations and SMEs across Indonesia.') };
